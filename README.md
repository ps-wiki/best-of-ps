...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 77 · 📦 12 · 📋 50 - 10% open · ⏱️ 22.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 1K / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulationsDynamics.jl) (👨‍💻 13 · 🔀 30 · 📋 120 - 32% open · ⏱️ 11.07.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 110 · 🔀 420 · 📦 250 · 📋 860 - 17% open · ⏱️ 20.07.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 62 · 🔀 360 · 📦 110 · 📋 260 - 22% open · ⏱️ 18.07.2023):
...
<details><summary><b><a href="https://www.advancedgridinsights.com/gridcal">GridCal</a></b> (🥈23 ·  ⭐ 330) - Cross-platform power systems software. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈22 ·  ⭐ 80) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 14 · 🔀 14 · 📥 510 · 📦 3 · 📋 80 - 37% open · ⏱️ 17.07.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 49 · 🔀 140 · 📋 320 - 36% open · ⏱️ 18.07.2023):
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 96 · 📦 85 · 📋 37 - 70% open · ⏱️ 29.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/PYPOWER) (📥 2.7K / month):
	```
	pip install PYPOWER
	```
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 130 · 📥 320K · 📋 160 - 15% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 450 / month):
	```
	pip install matpower
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 820 · ⏱️ 23.12.2022):
	```
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">LightSim2Grid</a></b> (🥉18 ·  ⭐ 36) - A fast backend for the Grid2Op. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 99 · 📦 24 · 📋 32 - 46% open · ⏱️ 20.07.2023):

	```
	git clone https://github.com/BDonnot/lightsim2grid/
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 4.3K / month):
	```
...
<details><summary><b><a href="https://pypsa.org">PyPSA-Eur-Sec</a></b> (🥉15 ·  ⭐ 81 · 📉) - Sector-Coupled Optimisation Model of the European Energy.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 38 · 📋 93 - 15% open · ⏱️ 02.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 3.4K / month):
	```
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 20 · 📋 53 - 60% open · ⏱️ 04.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 280 / month):
	```
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 23 · 🔀 16 · 📦 2 · 📋 25 - 64% open · ⏱️ 12.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydss) (📥 13 / month):
	```
	pip install pydss
	```
</details>
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 71 / month):
	```
	pip install dssdata
	```
</details>
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥈29 ·  ⭐ 570 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 21 · 📋 470 - 13% open · ⏱️ 05.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/highspy) (📥 9.1K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 43 · 📋 44 - 22% open · ⏱️ 19.07.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.5K · 📦 1.4K · 📋 1.2K - 24% open · ⏱️ 20.07.2023):

	```
	git clone https://github.com/Pyomo/pyomo
	```
- [PyPi](https://pypi.org/project/Pyomo) (📥 250K / month):
	```
	pip install Pyomo
	```
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 7.7K · 📋 180 - 22% open · ⏱️ 10.05.2023):

	```
	git clone https://github.com/cvxopt/cvxopt
	```
- [PyPi](https://pypi.org/project/cvxopt) (📥 180K / month):
	```
	pip install cvxopt
	```
- [Conda](https://anaconda.org/anaconda/cvxopt) (📥 9.3K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 140 · 🔀 370 · 📋 1.4K - 0% open · ⏱️ 20.07.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 27 · 🔀 89 · 📋 280 - 16% open · ⏱️ 06.07.2023):
...
- [PyPi](https://pypi.org/project/Grid2Op) (📥 2.3K / month):
	...
	pip install Grid2Op
	```
- [Docker Hub](https://hub.docker.com/r/bdonnot/grid2op) (📥 9.4K · ⭐ 1 · ⏱️ 05.07.2022):
	```
...
<details><summary><b><a href="https://openmodelica.org">OpenModelica</a></b> (🥇27 ·  ⭐ 620) - Modelica-based environment for modeling and simulation. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>

- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 350 · 📋 7.1K - 23% open · ⏱️ 20.07.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 51 · 🔀 150 · 📥 18K · 📋 730 - 25% open · ⏱️ 20.07.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 390 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 12K · ⏱️ 20.07.2023):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 89) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 17 · 🔀 41 · 📦 10 · 📋 110 - 36% open · ⏱️ 15.03.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 60 · 📦 23 · 📋 100 - 21% open · ⏱️ 18.07.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 870 / month):
	```
	pip install atlite
	```
