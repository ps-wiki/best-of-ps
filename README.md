...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 420 · 📦 280 · 📋 860 - 17% open · ⏱️ 31.08.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 63 · 🔀 370 · 📦 120 · 📋 270 - 22% open · ⏱️ 06.09.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 2K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 15 · 📥 450 · 📦 3 · 📋 85 - 35% open · ⏱️ 06.09.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 47 · 📋 270 - 7% open · ⏱️ 06.09.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 53 · 🔀 150 · 📋 330 - 34% open · ⏱️ 05.09.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 76 · 📥 32 · 📦 6 · 📋 79 - 2% open · ⏱️ 21.08.2023):
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 96 · 📦 88 · 📋 38 - 71% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 350K · 📋 160 - 15% open · ⏱️ 31.05.2023):
...
- [PyPi](https://pypi.org/project/matpower) (📥 100 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 920 · ⏱️ 23.12.2022):
	```
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">LightSim2Grid</a></b> (🥉17 ·  ⭐ 37) - A fast backend for the Grid2Op. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://dss-extensions.org/">OpenDSSDirect.py</a></b> (🥇20 ·  ⭐ 71 · 📈) - A direct library interface to OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 98 - 15% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 2.4K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 27 - 62% open · ⏱️ 17.08.2023):

	```
	git clone https://github.com/NREL/PyDSS
	```
- [PyPi](https://pypi.org/project/pydss) (📥 22 / month):
	```
	pip install pydss
	```
</details>
<details><summary><b><a href="https://github.com/PauloRadatz/py_dss_interface">py-dss-interface</a></b> (🥉14 ·  ⭐ 18) - A package for access to direct dll version of OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 22 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 310 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 8 / month):
	```
	pip install dssdata
	```
</details>
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇28 ·  ⭐ 610 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 29 · 📋 480 - 12% open · ⏱️ 05.09.2023):
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 27 · 🔀 240 · 📥 8.7K · 📋 540 - 1% open · ⏱️ 18.08.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 48 · ⏱️ 06.09.2023):

	```
	git clone https://github.com/ampl/amplpy
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 7.8K / month):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.7K · 📦 1.5K · 📋 1.2K - 25% open · ⏱️ 05.09.2023):
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 7.9K · 📋 180 - 18% open · ⏱️ 09.08.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 140 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 06.09.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 29 · 🔀 96 · 📋 290 - 13% open · ⏱️ 04.09.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 360 · 📋 7.2K - 23% open · ⏱️ 07.09.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 19K · 📋 750 - 24% open · ⏱️ 05.09.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 620 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 13K · ⏱️ 07.09.2023):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 17 · 🔀 41 · 📦 11 · 📋 110 - 36% open · ⏱️ 01.09.2023):

	```
	git clone https://github.com/e2nIEE/pandapipes
	```
- [PyPi](https://pypi.org/project/pandapipes) (📥 960 / month):
	```
...
- [GitHub](https://github.com/CURENT/agvis) (👨‍💻 9 · 🔀 6 · 📥 9 · 📋 17 - 70% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 65 · 📦 30 · 📋 110 - 22% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 720 / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 47 · 📥 51 · 📦 23 · 📋 72 - 25% open · ⏱️ 25.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 380 / month):
	```
