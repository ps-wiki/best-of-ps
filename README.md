...
<details><summary><b><a href="https://www.nrel.gov/analysis/siip.html">PowerSimulationsDynamics.jl</a></b> (🥈16 ·  ⭐ 140) - Dynamic Power System simulations; Part of the SIIP at.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://www.pandapower.org/">pandapower</a></b> (🥇31 ·  ⭐ 680) - Convenient Power System Modelling and Analysis. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 420 · 📦 290 · 📋 880 - 18% open · ⏱️ 24.10.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 65 · 🔀 380 · 📦 130 · 📋 280 - 23% open · ⏱️ 02.11.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 4.4K / month):
	```
	pip install pypsa
	```
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈24 ·  ⭐ 95 · 📈) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 17 · 📥 610 · 📦 4 · 📋 91 - 37% open · ⏱️ 01.11.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 48 · 📋 270 - 7% open · ⏱️ 01.11.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 75 · 📥 32 · 📦 7 · 📋 130 - 38% open · ⏱️ 21.08.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 55 · 🔀 160 · 📋 340 - 35% open · ⏱️ 02.11.2023):
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 25 · 📋 38 - 31% open · ⏱️ 05.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 390K · 📋 170 - 15% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 100 / month):
	```
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 97 · 📦 93 · 📋 38 - 71% open · ⏱️ 29.03.2023):
...
<details><summary><b><a href="https://www.gridpath.io/">GridPath</a></b> (🥉18 ·  ⭐ 74) - Power system planning and operations. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 8 · 🔀 31 · 📥 650 · 📦 2 · 📋 310 - 19% open · ⏱️ 30.10.2023):
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 40 · 📋 95 - 15% open · ⏱️ 02.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 98 - 15% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 2.2K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 29 - 58% open · ⏱️ 26.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydss) (📥 38 / month):
	```
	pip install pydss
	```
</details>
<details><summary><b><a href="https://github.com/PauloRadatz/py_dss_interface">py-dss-interface</a></b> (🥉13 ·  ⭐ 20) - A package for access to direct dll version of OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 22 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 550 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 42 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 66 · 🔀 210 · 📦 130 · 📋 450 - 5% open · ⏱️ 27.10.2023):
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 58 · 🔀 130 · 📦 40 · 📋 510 - 12% open · ⏱️ 04.10.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 25K / month):
	```
	pip install highspy
	```
</details>
<details><summary><b><a href="https://github.com/coin-or/Ipopt">Ipopt</a></b> (🥉24 ·  ⭐ 1.2K) - COIN-OR Interior Point Optimizer. <code><a href="http://bit.ly/2M0xmjV">EPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 29 · 🔀 240 · 📥 9.3K · 📋 550 - 0% open · ⏱️ 01.11.2023):

	```
	git clone https://github.com/coin-or/Ipopt
	```
- [PyPi](https://pypi.org/project/ipopt) (📥 1.8K / month):
	```
	pip install ipopt
	```
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 52 · 📋 44 - 2% open · ⏱️ 03.10.2023):

	```
	git clone https://github.com/ampl/amplpy
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 16K / month):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.9K · 📦 1.5K · 📋 1.2K - 24% open · ⏱️ 31.10.2023):
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 8.3K · 📋 180 - 20% open · ⏱️ 09.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/cvxopt) (📥 300K / month):
	```
	pip install cvxopt
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 02.11.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 31 · 🔀 100 · 📋 310 - 12% open · ⏱️ 26.10.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.3K - 23% open · ⏱️ 02.11.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 21K · 📋 760 - 23% open · ⏱️ 31.10.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 350 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 02.11.2023):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 98) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 18 · 🔀 45 · 📦 12 · 📋 120 - 38% open · ⏱️ 19.09.2023):

	```
	git clone https://github.com/e2nIEE/pandapipes
	```
- [PyPi](https://pypi.org/project/pandapipes) (📥 940 / month):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 68 · 📦 40 · 📋 110 - 21% open · ⏱️ 31.10.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 1.8K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 46 · 📥 51 · 📦 32 · 📋 73 - 26% open · ⏱️ 31.10.2023):
...
<details><summary><b><a href="https://github.com/gseim/gseim">GSEIM</a></b> (🥇4 ·  ⭐ 7) - Interface Python to Ngspice and Xyce. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
