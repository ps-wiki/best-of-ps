...
<details><summary><b><a href="https://github.com/OpenIPSL/OpenIPSL">OpenIPSL</a></b> (🥈16 ·  ⭐ 59) - A library of power system models written with Modelica. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 65 · 🔀 370 · 📦 130 · 📋 280 - 23% open · ⏱️ 28.09.2023):
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈23 ·  ⭐ 84) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 16 · 📥 560 · 📦 3 · 📋 88 - 36% open · ⏱️ 26.09.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 75 · 📥 32 · 📦 7 · 📋 79 - 2% open · ⏱️ 21.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 2.7K / month):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 54 · 🔀 150 · 📋 330 - 35% open · ⏱️ 28.09.2023):
...
- [PyPi](https://pypi.org/project/matpower) (📥 120 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 970 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 38 · 🔀 36 · 📥 19K · 📋 620 - 11% open · ⏱️ 11.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 1.2K / month):
	```
	pip install helics
	```
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 27 - 55% open · ⏱️ 26.09.2023):
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 32 / month):
	```
	pip install dssdata
	```
</details>
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇30 ·  ⭐ 630 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 58 · 🔀 130 · 📦 30 · 📋 500 - 12% open · ⏱️ 28.09.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 22K / month):
	```
	pip install highspy
	```
</details>
<details><summary><b><a href="https://www.scipopt.org/">PySCIPOpt</a></b> (🥈27 ·  ⭐ 670 · ➕) - Python interface for SCIP. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 64 · 🔀 210 · 📦 130 · 📋 440 - 5% open · ⏱️ 03.07.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 49 · ⏱️ 21.09.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.8K · 📦 1.5K · 📋 1.2K - 24% open · ⏱️ 25.09.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 25.09.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 30 · 🔀 98 · 📋 300 - 12% open · ⏱️ 18.09.2023):
...
<details><summary><b><a href="https://openmodelica.org">OpenModelica</a></b> (🥇27 ·  ⭐ 650) - Modelica-based environment for modeling and simulation. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>

- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 360 · 📋 7.2K - 23% open · ⏱️ 28.09.2023):

	```
	git clone https://github.com/OpenModelica/OpenModelica
	```
- [Docker Hub](https://hub.docker.com/r/openmodelica/openmodelica) (📥 26K · ⭐ 5 · ⏱️ 05.05.2023):
	```
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 20K · 📋 750 - 23% open · ⏱️ 27.09.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 13K · ⏱️ 28.09.2023):
	```
...
- [GitHub](https://github.com/CURENT/agvis) (👨‍💻 9 · 🔀 6 · 📥 9 · 📋 19 - 68% open · ⏱️ 13.09.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 67 · 📦 32 · 📋 110 - 21% open · ⏱️ 27.09.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 400 / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 46 · 📥 51 · 📦 25 · 📋 72 - 25% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 85 / month):
	```
