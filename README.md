...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 68 · 🔀 390 · 📦 150 · 📋 300 - 24% open · ⏱️ 19.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 6.4K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 32 · 🔀 75 · 📥 33 · 📦 7 · 📋 130 - 38% open · ⏱️ 28.11.2023):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 18 · 🔀 20 · 📥 610 · 📦 4 · 📋 100 - 38% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 49 · 📋 280 - 9% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 15 · 🔀 140 · 📥 420K · 📋 180 - 16% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 190 / month):
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 57 · 🔀 170 · 📋 350 - 36% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 38 · 🔀 37 · 📥 20K · 📋 630 - 12% open · ⏱️ 11.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 1.4K / month):
	```
	pip install helics
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 28 / month):
	```
	pip install dssdata
	```
</details>
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇31 ·  ⭐ 700 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 140 · 📦 53 · 📋 540 - 11% open · ⏱️ 28.11.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 33K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 67 · 🔀 210 · 📦 140 · 📋 460 - 4% open · ⏱️ 11.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 41K / month):
	```
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 16 · 📦 55 · 📋 45 - 4% open · ⏱️ 11.12.2023):
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 200 · 📦 8.7K · 📋 180 - 20% open · ⏱️ 09.08.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 31 · 🔀 100 · 📋 320 - 13% open · ⏱️ 01.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 2.2K / month):
	```
	pip install Grid2Op
	```
...
<details><summary><b><a href="https://openmodelica.org">OpenModelica</a></b> (🥇28 ·  ⭐ 680) - Modelica-based environment for modeling and simulation. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>

- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.4K - 23% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 22K · 📋 790 - 22% open · ⏱️ 18.12.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 21.12.2023):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 20 · 🔀 46 · 📦 14 · 📋 120 - 37% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 66 · 📦 46 · 📋 110 - 21% open · ⏱️ 18.12.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 2.5K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 22 · 🔀 47 · 📥 52 · 📦 37 · 📋 74 - 27% open · ⏱️ 31.10.2023):
...
<details><summary><b><a href="https://github.com/gseim/gseim">GSEIM</a></b> (🥇6 ·  ⭐ 7) - Interface Python to Ngspice and Xyce. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
