...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 80 · 📋 52 - 11% open · ⏱️ 11.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 890 / month):
	```
	pip install andes
	```
...
<details><summary><b><a href="https://github.com/changgang/steps">STEPS</a></b> (🥉12 ·  ⭐ 39 · 📈) - Balanced large-scale AC-DC hybrid power system analysis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 69 · 🔀 390 · 📦 150 · 📋 300 - 24% open · ⏱️ 25.01.2024):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 5.1K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 18 · 🔀 21 · 📥 590 · 📦 4 · 📋 110 - 38% open · ⏱️ 24.01.2024):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 61 · 🔀 170 · 📋 370 - 36% open · ⏱️ 25.01.2024):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 34 · 🔀 48 · 📋 280 - 9% open · ⏱️ 23.01.2024):
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 100 · 📦 96 · 📋 38 - 71% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 9 · 🔀 33 · 📥 740 · 📦 2 · 📋 320 - 20% open · ⏱️ 14.12.2023):
...
- [GitHub](https://github.com/grid-parity-exchange/Egret) (👨‍💻 38 · 🔀 45 · 📦 6 · 📋 82 - 53% open · ⏱️ 14.11.2023):
...
- [GitHub](https://github.com/CURENT/ltb) (👨‍💻 4 · 🔀 1 · 📋 5 - 20% open · ⏱️ 29.04.2023):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 38 · 🔀 37 · 📥 20K · 📋 630 - 11% open · ⏱️ 24.01.2024):
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 43 · 📋 98 - 16% open · ⏱️ 02.07.2023):
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 24 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 360 / month):
	```
	pip install py-dss-interface
	```
</details>
<details><summary><b><a href="https://www.nrel.gov/grid/pydss.html">PyDSS</a></b> (🥉14 ·  ⭐ 30) - A Python wrapper for OpenDSS. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 140 · 📦 56 · 📋 560 - 13% open · ⏱️ 12.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/highspy) (📥 27K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 67 · 🔀 220 · 📦 140 · 📋 470 - 3% open · ⏱️ 11.01.2024):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 57 · 📋 46 - 2% open · ⏱️ 05.01.2024):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 140 · 🔀 460 · 📥 2K · 📦 1.7K · 📋 1.3K - 21% open · ⏱️ 24.01.2024):
...
<details><summary><b><a href="https://cvxopt.org/">CVXOPT</a></b> (🥉27 ·  ⭐ 940 · ➕) - Python Software for Convex Optimization. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/cvxopt) (📥 290K / month):
	...
	pip install cvxopt
	```
- [Conda](https://anaconda.org/anaconda/cvxopt) (📥 11K · ⏱️ 07.11.2023):
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 23.01.2024):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 280 · 📥 360 · 📋 7.5K - 24% open · ⏱️ 25.01.2024):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 55 · 🔀 160 · 📥 23K · 📋 790 - 22% open · ⏱️ 22.01.2024):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 130 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 25.01.2024):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 20 · 🔀 47 · 📦 16 · 📋 120 - 37% open · ⏱️ 22.12.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 29 · 🔀 69 · 📦 47 · 📋 110 - 22% open · ⏱️ 25.01.2024):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 2.9K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 22 · 🔀 47 · 📥 52 · 📦 38 · 📋 75 - 26% open · ⏱️ 23.01.2024):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 800 / month):
	```
