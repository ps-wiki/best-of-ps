...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 76 · 📦 12 · 📋 50 - 10% open · ⏱️ 11.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 480 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulationsDynamics.jl) (👨‍💻 13 · 🔀 31 · 📋 120 - 31% open · ⏱️ 22.08.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 420 · 📦 270 · 📋 860 - 17% open · ⏱️ 21.08.2023):
...
<details><summary><b><a href="https://pypsa.org">PyPSA</a></b> (🥇30 ·  ⭐ 910) - Simulating and optimising power and energy systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 63 · 🔀 360 · 📦 120 · 📋 270 - 22% open · ⏱️ 22.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 2.4K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 14 · 📥 470 · 📦 3 · 📋 83 - 33% open · ⏱️ 24.08.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 30 · 🔀 47 · 📋 270 - 7% open · ⏱️ 10.08.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 53 · 🔀 140 · 📋 330 - 34% open · ⏱️ 24.08.2023):
...
<details><summary><b><a href="https://github.com/lanl-ansi/PowerModels.jl">PowerModels.jl</a></b> (🥉19 ·  ⭐ 340) - Power Network Optimization. <code><a href="https://tldrlegal.com/search?q=BSD">❗️BSD</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lanl-ansi/PowerModels.jl) (👨‍💻 28 · 🔀 130 · 📋 460 - 18% open · ⏱️ 13.08.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 340K · 📋 160 - 15% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 170 / month):
	```
	pip install matpower
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 890 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 25 · 📋 32 - 46% open · ⏱️ 24.08.2023):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 7 · 🔀 28 · 📥 610 · 📋 310 - 20% open · ⏱️ 24.01.2023):
...
<details><summary><b><a href="https://helics.org/tools/">HELICS</a></b> (🥇19 ·  ⭐ 98 · 📉) - Framework to Integrate Simulators. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 38 · 📋 95 - 15% open · ⏱️ 02.07.2023):
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 25 - 60% open · ⏱️ 17.08.2023):
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥈28 ·  ⭐ 580 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 27 · 📋 480 - 12% open · ⏱️ 05.07.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 17K / month):
	```
	pip install highspy
	```
</details>
...
<details><summary><b><a href="https://ampl.com/">AMPLPY</a></b> (🥉21 ·  ⭐ 56 · ➕) - Python API for AMPL. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 47 · 📋 44 - 22% open · ⏱️ 19.07.2023):

	```
	git clone https://github.com/ampl/amplpy
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 5.8K / month):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.6K · 📦 1.5K · 📋 1.2K - 25% open · ⏱️ 24.08.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 140 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 16.08.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 29 · 🔀 94 · 📋 290 - 16% open · ⏱️ 21.08.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 360 · 📋 7.1K - 23% open · ⏱️ 24.08.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 19K · 📋 740 - 24% open · ⏱️ 24.08.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 570 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 13K · ⏱️ 24.08.2023):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 17 · 🔀 41 · 📦 10 · 📋 110 - 36% open · ⏱️ 18.08.2023):

	```
	git clone https://github.com/e2nIEE/pandapipes
	```
- [PyPi](https://pypi.org/project/pandapipes) (📥 990 / month):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 62 · 📦 28 · 📋 110 - 23% open · ⏱️ 25.07.2023):
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 45 · 📥 51 · 📦 23 · 📋 72 - 25% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 570 / month):
	```
