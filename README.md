...
- [GitHub](https://github.com/sogno-platform/dpsim) (👨‍💻 42 · 🔀 79 · 📦 3 · 📋 200 - 39% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/changgang/steps) (👨‍💻 9 · 🔀 23 · 📥 88 · 📦 7 · 📋 4 - 25% open · ⏱️ 02.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/stepspy) (📥 62 / month · ⏱️ 02.02.2026):
	```
	pip install stepspy
	```
...
- [GitHub](https://github.com/SanPen/VeraGrid) (👨‍💻 59 · 🔀 130 · 📥 62 · 📋 300 - 3% open · ⏱️ 29.07.2026):
...
<details><summary><b><a href="https://xyce.sandia.gov/">Xyce</a></b> (🥉15 ·  ⭐ 160) - The Xyce Parallel Electronic Simulator. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/cpp.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/lab.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Xyce/Xyce) (👨‍💻 8 · 🔀 25 · 📥 1.2K · 📋 120 - 34% open · ⏱️ 01.06.2026):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 200 · 🔀 590 · 📦 590 · 📋 1.2K - 13% open · ⏱️ 17.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/pandapower) (📥 580K / month · 📦 110 · ⏱️ 08.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/pandapower) (📥 44K · ⏱️ 27.10.2025):
	...
	```
- [Docker Hub](https://hub.docker.com/r/pauldepraz/pandapowerapi) (📥 250 · ⏱️ 09.02.2021):
	```
	docker pull pauldepraz/pandapowerapi
	```
- Paper (📚 1112 citations): [10.1109/TPWRS.2018.2829021](https://doi.org/10.1109/TPWRS.2018.2829021)
</details>
<details><summary><b><a href="https://pypsa.org">PyPSA</a></b> (🥇42 ·  ⭐ 2.1K) - Python for Power System Analysis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/university.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 120 · 🔀 670 · 📦 340 · 📋 620 - 23% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 260 · 🔀 73 · 📥 1.9K · 📦 40 · 📋 330 - 35% open · ⏱️ 27.07.2026):

	```
	git clone https://github.com/PowerGridModel/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 100K / month · 📦 15 · ⏱️ 27.07.2026):
	```
	pip install power-grid-model
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 5.2M · ⏱️ 27.07.2026):
	```
	conda install -c conda-forge power-grid-model
	```
- Paper (📚 8 citations): [10.1049/icp.2023.0633](https://doi.org/10.1049/icp.2023.0633)
</details>
<details><summary><b><a href="https://matpower.org/">MATPOWER</a></b> (🥇33 ·  ⭐ 570) - Steady state power flow simulation. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/octave.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/university.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 23 · 🔀 180 · 📥 760K · 📋 240 - 9% open · ⏱️ 22.06.2026):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 27K · ⏱️ 22.06.2026):
	```
	docker pull matpower/matpower
	```
- Paper (📚 6778 citations): [10.1109/TPWRS.2010.2051168](https://doi.org/10.1109/TPWRS.2010.2051168)
</details>
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 22 · 🔀 120 · 📦 170 · 📋 57 - 73% open · ⏱️ 24.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/PYPOWER) (📥 45K / month · 📦 20 · ⏱️ 10.07.2025):
	```
	pip install PYPOWER
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 110 · 🔀 410 · 📋 710 - 33% open · ⏱️ 30.07.2026):
...
- [Docker Hub](https://hub.docker.com/r/nimfetrisa/pypsa-eur):
	...
	```
- Papers (📚 783 citations): [10.1016/j.esr.2018.08.012](https://doi.org/10.1016/j.esr.2018.08.012), [10.1016/j.joule.2023.06.016](https://doi.org/10.1016/j.joule.2023.06.016), [10.1016/j.joule.2022.04.016](https://doi.org/10.1016/j.joule.2022.04.016)
</details>
...
- [GitHub](https://github.com/Sienna-Platform/PowerSimulations.jl) (👨‍💻 57 · 🔀 86 · 📋 480 - 6% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/pypsa-meets-earth/pypsa-earth) (👨‍💻 96 · 🔀 340 · 📋 720 - 41% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/grid-parity-exchange/Egret) (👨‍💻 42 · 🔀 67 · 📋 90 - 57% open · ⏱️ 29.05.2026):
	...
	```
- Paper (📚 150 citations): [10.1287/ijoc.2019.0944](https://doi.org/10.1287/ijoc.2019.0944)
</details>
...
- [GitHub](https://github.com/IIT-EnergySystemModels/openTEPES) (👨‍💻 10 · 🔀 28 · 📥 120 · 📋 20 - 20% open · ⏱️ 30.07.2026):

	```
	git clone https://github.com/IIT-EnergySystemModels/openTEPES
	```
- [PyPi](https://pypi.org/project/openTEPES) (📥 170 / month · ⏱️ 10.04.2026):
	```
...
- [GitHub](https://github.com/Sienna-Platform/PowerFlows.jl) (👨‍💻 18 · 🔀 23 · 📋 170 - 14% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/sylvan-energy/gridpath) (👨‍💻 16 · 🔀 66 · 📥 1.4K · 📦 5 · 📋 350 - 16% open · ⏱️ 27.07.2026):

	```
	git clone https://github.com/sylvan-energy/gridpath
	```
- [PyPi](https://pypi.org/project/GridPath) (📥 800 / month · ⏱️ 27.07.2026):
	```
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 15 · 📥 300 · 📦 89 · 📋 65 - 27% open · ⏱️ 21.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 27K / month · 📦 8 · ⏱️ 06.07.2026):
	```
	pip install LightSim2Grid
	```
- [Docker Hub](https://hub.docker.com/r/bdonnot/lightsim2grid) (📥 1.3K · ⏱️ 01.02.2022):
	```
	docker pull bdonnot/lightsim2grid
	```
</details>
<details><summary><b><a href="https://matpower.org/">MOST</a></b> (🥈21 ·  ⭐ 39) - MATPOWER Optimal Scheduling Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/octave.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/university.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/MATPOWER/most) (👨‍💻 2 · 🔀 14 · 📋 45 - 17% open · ⏱️ 22.06.2026):
	...
	```
- Papers (📚 6990 citations): [10.1109/TPWRS.2010.2051168](https://doi.org/10.1109/TPWRS.2010.2051168), [10.1109/TSG.2013.2281001](https://doi.org/10.1109/TSG.2013.2281001)
</details>
...
- [GitHub](https://github.com/CURENT/ams) (👨‍💻 7 · 🔀 9 · 📥 160 · 📦 3 · 📋 24 - 37% open · ⏱️ 03.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/ltbams) (📥 230 / month · ⏱️ 03.05.2026):
	```
	pip install ltbams
	```
...
- [GitHub](https://github.com/NatLabRockies/REopt_API) (👨‍💻 26 · 🔀 66 · 📥 580 · 📋 86 - 51% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/NLR-Distribution-Suite/erad) (👨‍💻 8 · 🔀 13 · 📦 3 · ⏱️ 30.07.2026):

	```
	git clone https://github.com/NLR-Distribution-Suite/erad
	```
- [PyPi](https://pypi.org/project/NREL-erad) (📥 440 / month · ⏱️ 16.07.2026):
	```
...
- [GitHub](https://github.com/powsybl/powsybl-open-rao) (👨‍💻 44 · 🔀 10 · 📥 55 · 📋 270 - 27% open · ⏱️ 30.07.2026):
...
<details><summary><b><a href="https://github.com/bukhsh/oats">OATS</a></b> (🥉15 ·  ⭐ 29 · 💤) - Optimisation and Analysis Toolbox for Power Systems. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/university.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/bukhsh/oats) (👨‍💻 4 · 🔀 9 · 📦 3 · 📋 79 - 29% open · ⏱️ 11.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/oatspower) (📥 20 / month · 📦 1 · ⏱️ 28.01.2020):
	```
...
- [GitHub](https://github.com/ReEDS-Model/ReEDS) (👨‍💻 23 · 🔀 11 · 📋 69 - 75% open · ⏱️ 28.07.2026):
...
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 400K / month · 📦 110 · ⏱️ 16.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyscipopt) (📥 810K · ⏱️ 16.05.2026):
	```
...
- [GitHub](https://github.com/powsybl/pypowsybl) (👨‍💻 48 · 🔀 26 · 📥 580 · 📋 310 - 29% open · ⏱️ 22.07.2026):
...
- [GitHub](https://github.com/FraunhIEE-UniKassel-PowSysStability/powfacpy) (👨‍💻 2 · 🔀 6 · 📦 5 · 📋 41 - 17% open · ⏱️ 03.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/powfacpy) (📥 390 / month · ⏱️ 22.07.2026):
	```
...
- [GitHub](https://github.com/yasirroni/matpower-pip) (👨‍💻 2 · 🔀 3 · 📦 14 · 📋 22 - 31% open · ⏱️ 03.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/matpower) (📥 930 / month · 📦 2 · ⏱️ 25.02.2026):
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 210 · 🔀 390 · 📥 1.7K · 📋 8.9K - 24% open · ⏱️ 30.07.2026):

	```
	git clone https://github.com/OpenModelica/OpenModelica
	```
- [Docker Hub](https://hub.docker.com/r/openmodelica/openmodelica) (📥 79K · ⭐ 6 · ⏱️ 03.07.2026):
	```
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 53 · 📥 33K · 📋 680 - 14% open · ⏱️ 30.07.2026):
...
- [Julia](https://juliahub.com/ui/Packages/General/HELICS) (📥 23 / month):
	...
	```
- Paper (📚 63 citations): [10.1109/ACCESS.2024.3363615](https://doi.org/10.1109/ACCESS.2024.3363615)
</details>
...
- [Conda](https://anaconda.org/conda-forge/pyprecice) (📥 180K · ⏱️ 08.04.2026):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 47K · ⏱️ 30.07.2026):
	```
...
- [GitHub](https://github.com/pnnl/tesp) (👨‍💻 31 · 🔀 42 · 📥 530 · 📦 2 · 📋 130 - 27% open · ⏱️ 05.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/tesp_support) (📥 140 / month · ⏱️ 05.02.2026):
	```
...
- [GitHub](https://github.com/cvxpy/cvxpy) (👨‍💻 260 · 🔀 1.2K · 📥 830 · 📦 19K · 📋 1.7K - 11% open · ⏱️ 28.07.2026):

	```
	git clone https://github.com/cvxpy/cvxpy
	```
- [PyPi](https://pypi.org/project/cvxpy) (📥 4.8M / month · 📦 1K · ⏱️ 22.06.2026):
	```
	pip install cvxpy
	```
...
- [Julia](https://juliahub.com/ui/Packages/General/JuMP) (📥 30K / month):
	...
	```
- Paper (📚 331 citations): [10.1007/s12532-023-00239-3](https://doi.org/10.1007/s12532-023-00239-3)
</details>
<details><summary><b><a href="https://github.com/exanauts/ExaModels.jl">ExaModels</a></b> (🥉25 ·  ⭐ 80) - An algebraic modeling and automatic differentiation tool.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/julia.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/lab.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/exanauts/ExaModels.jl) (👨‍💻 14 · 🔀 10 · 📋 54 - 16% open · ⏱️ 24.06.2026):
...
- [GitHub](https://github.com/XiongPengNUS/rsome) (👨‍💻 3 · 🔀 61 · 📋 45 - 15% open · ⏱️ 15.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/rsome) (📥 680 / month · 📦 4 · ⏱️ 29.10.2024):
	```
	pip install rsome
	```
...
- [GitHub](https://github.com/Gurobi/gurobi-optimods) (👨‍💻 17 · 🔀 38 · 📦 10 · 📋 87 - 28% open · ⏱️ 09.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/gurobi-optimods) (📥 420 / month · 📦 2 · ⏱️ 09.04.2026):
	```
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 120 · 🔀 330 · 📥 74K · 📋 1.2K - 14% open · ⏱️ 02.07.2026):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 3.4M / month · 📦 210 · ⏱️ 02.07.2026):
	```
	pip install highspy
	```
- [Conda](https://anaconda.org/conda-forge/highs) (📥 96K · ⏱️ 10.07.2026):
	```
...
- [Julia](https://juliahub.com/ui/Packages/General/HiGHS) (📥 15K / month):
	...
	```
- Paper (📚 361 citations): [10.1007/s12532-017-0130-5](https://doi.org/10.1007/s12532-017-0130-5)
</details>
...
- [Julia](https://juliahub.com/ui/Packages/General/OSQP) (📥 960 / month):
	...
	```
- Paper (📚 1164 citations): [10.1007/s12532-020-00179-2](https://doi.org/10.1007/s12532-020-00179-2)
</details>
...
- [GitHub](https://github.com/cvxgrp/scs) (👨‍💻 32 · 🔀 140 · 📋 190 - 22% open · ⏱️ 28.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/scs) (📥 3.8M / month · 📦 72 · ⏱️ 09.01.2026):
	```
	pip install scs
	```
...
- [GitHub](https://github.com/google/or-tools) (👨‍💻 200 · 🔀 2.4K · 📥 450K · 📦 370 · 📋 3.2K - 3% open · ⏱️ 09.06.2026):
...
- [Conda](https://anaconda.org/conda-forge/ipopt) (📥 2.7M · ⏱️ 17.02.2026):
	...
	```
- Paper (📚 9534 citations): [10.1007/s10107-004-0559-y](https://doi.org/10.1007/s10107-004-0559-y)
</details>
...
- [GitHub](https://github.com/xopt-org/Xopt) (👨‍💻 28 · 🔀 39 · 📦 28 · 📋 100 - 18% open · ⏱️ 25.07.2026):
	...
	```
- [PyPi](https://pypi.org/project/xopt) (📥 5.3K / month · 📦 12 · ⏱️ 20.07.2026):
	```
	pip install xopt
	```
...
- [GitHub](https://github.com/PREDICT-EPFL/piqp) (👨‍💻 6 · 🔀 22 · 📥 1.4K · 📦 53 · 📋 21 - 23% open · ⏱️ 16.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/piqp) (📥 86K / month · 📦 13 · ⏱️ 11.05.2026):
	```
	pip install piqp
	```
...
- [GitHub](https://github.com/oxfordcontrol/Clarabel.rs) (👨‍💻 11 · 🔀 48 · 📦 92 · 📋 75 - 32% open · ⏱️ 13.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/clarabel) (📥 3.8M / month · 📦 43 · ⏱️ 11.06.2025):
	```
...
- [GitHub](https://github.com/MadNLP/MadNLP.jl) (👨‍💻 20 · 🔀 30 · 📋 140 - 24% open · ⏱️ 23.07.2026):
...
- [GitHub](https://github.com/kvxopt/kvxopt) (👨‍💻 16 · 🔀 1 · 📥 8 · 📦 34 · ⏱️ 22.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/kvxopt) (📥 6.7K / month · 📦 14 · ⏱️ 22.02.2026):
	```
	pip install kvxopt
	```
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 150 · 📥 1 · 📋 410 - 15% open · ⏱️ 18.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 15K / month · 📦 9 · ⏱️ 18.06.2026):
	```
	pip install Grid2Op
	```
...
🔗&nbsp;<b><a href="https://github.com/lbl-hub/CSEE-Benchmark">A new power system benchmark</a></b> ( ⭐ 47)  - A new type of power system calculation example by the.. <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/lab.ico" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 47 · 🔀 82 · 📦 29 · 📋 160 - 32% open · ⏱️ 30.07.2026):

	```
	git clone https://github.com/gridstatus/gridstatus
	```
- [PyPi](https://pypi.org/project/gridstatus) (📥 91K / month · 📦 2 · ⏱️ 21.04.2026):
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 37 · 🔀 73 · 📥 87 · 📦 88 · 📋 120 - 23% open · ⏱️ 23.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 4.7K / month · ⏱️ 11.02.2026):
	```
...
- [GitHub](https://github.com/Sienna-Platform/PowerSystemsInvestmentsPortfolios.jl) (👨‍💻 7 · 🔀 9 · 📋 71 - 25% open · ⏱️ 30.07.2026):
...
- [GitHub](https://github.com/cuihantao/PowerfulCases) (⏱️ 19.01.2026):
	...
	```
- [PyPi](https://pypi.org/project/powerfulcases) (📥 34 / month · ⏱️ 29.12.2025):
	```
...
- [GitHub](https://github.com/open-energy-transition/pypsa-mcp) (👨‍💻 2 · 🔀 8 · 📥 11 · ⏱️ 20.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/pypsamcp) (📥 45 / month · ⏱️ 20.03.2026):
	```
