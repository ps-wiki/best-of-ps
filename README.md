...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulationsDynamics.jl) (👨‍💻 13 · 🔀 31 · 📋 120 - 33% open · ⏱️ 31.07.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 110 · 🔀 420 · 📦 250 · 📋 860 - 17% open · ⏱️ 31.07.2023):
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈23 ·  ⭐ 80) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 14 · 📥 360 · 📦 3 · 📋 82 - 36% open · ⏱️ 03.08.2023):
...
<details><summary><b><a href="https://www.nrel.gov/analysis/siip.html">PowerSimulations.jl</a></b> (🥈21 ·  ⭐ 230) - Optimization of Power Systems; Part of the SIIP at.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 50 · 🔀 140 · 📋 330 - 36% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/matpower) (📥 470 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 850 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 68 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 25 · 📋 480 - 12% open · ⏱️ 05.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/highspy) (📥 11K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 27 · 🔀 240 · 📥 8.4K · 📋 540 - 1% open · ⏱️ 21.06.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 43 · 📋 44 - 22% open · ⏱️ 19.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 9.6K / month):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.6K · 📦 1.4K · 📋 1.2K - 24% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/Pyomo/pyomo
	```
- [PyPi](https://pypi.org/project/Pyomo) (📥 270K / month):
	```
	pip install Pyomo
	```
...
- [PyPi](https://pypi.org/project/cvxopt) (📥 200K / month):
	...
	pip install cvxopt
	```
- [Conda](https://anaconda.org/anaconda/cvxopt) (📥 9.5K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 140 · 🔀 370 · 📋 1.4K - 0% open · ⏱️ 31.07.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 28 · 🔀 91 · 📋 290 - 16% open · ⏱️ 28.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 2.6K / month):
	```
	pip install Grid2Op
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 350 · 📋 7.1K - 23% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 52 · 🔀 150 · 📥 18K · 📋 740 - 24% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 320 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 12K · ⏱️ 03.08.2023):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 91) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 17 · 🔀 41 · 📦 10 · 📋 110 - 36% open · ⏱️ 31.07.2023):
...
<details><summary><b><a href="https://www.nrel.gov/analysis/siip.html">PowerGraphics</a></b> (🥇12 ·  ⭐ 21) - Visualization for PowerSimulations; Part of the SIIP at NREL. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/CURENT/agvis) (👨‍💻 9 · 🔀 6 · 📥 9 · 📋 15 - 80% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 61 · 📦 25 · 📋 100 - 22% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 930 / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 45 · 📥 51 · 📦 20 · 📋 71 - 23% open · ⏱️ 25.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 370 / month):
	```
