...
<details><summary><b><a href="https://github.com/OpenIPSL/OpenIPSL">OpenIPSL</a></b> (🥇17 ·  ⭐ 63) - A library of power system models written with Modelica. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 430 · 📦 300 · 📋 890 - 18% open · ⏱️ 23.11.2023):

	```
	git clone https://github.com/e2nIEE/pandapower
	```
- [PyPi](https://pypi.org/project/pandapower) (📥 19K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 66 · 🔀 380 · 📦 140 · 📋 290 - 23% open · ⏱️ 22.11.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 6.5K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 31 · 🔀 75 · 📥 32 · 📦 7 · 📋 130 - 39% open · ⏱️ 23.11.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 48 · 📋 280 - 9% open · ⏱️ 21.11.2023):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 20 · 📥 630 · 📦 4 · 📋 99 - 37% open · ⏱️ 22.11.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 57 · 🔀 160 · 📋 340 - 35% open · ⏱️ 23.11.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 410K · 📋 170 - 16% open · ⏱️ 31.05.2023):
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">LightSim2Grid</a></b> (🥉19 ·  ⭐ 40) - A fast backend for the Grid2Op. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 26 · 📋 38 - 31% open · ⏱️ 05.10.2023):
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 9 · 📦 3 · 📋 98 - 15% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/mzy2240/ESA
	```
- [PyPi](https://pypi.org/project/esa) (📥 1.5K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 22 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 460 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 46 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 140 · 📦 49 · 📋 530 - 11% open · ⏱️ 22.11.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 30K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 66 · 🔀 210 · 📦 130 · 📋 460 - 3% open · ⏱️ 21.11.2023):

	```
	git clone https://github.com/scipopt/PySCIPOpt
	```
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 67K / month):
	```
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 53 · 📋 44 - 2% open · ⏱️ 17.11.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.9K · 📦 1.6K · 📋 1.3K - 24% open · ⏱️ 20.11.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 22.11.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.3K - 23% open · ⏱️ 23.11.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 21K · 📋 780 - 22% open · ⏱️ 22.11.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 23.11.2023):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 66 · 📦 44 · 📋 110 - 21% open · ⏱️ 08.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/atlite) (📥 3K / month):
	```
	pip install atlite
	```
...
<details><summary><b><a href="https://pypsa.org">powerplantmatching</a></b> (🥉19 ·  ⭐ 130) - Tools to combine multiple power plant databases. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 46 · 📥 51 · 📦 35 · 📋 73 - 26% open · ⏱️ 31.10.2023):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 530 / month):
	```
