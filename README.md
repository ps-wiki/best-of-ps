...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 75 · 📦 11 · 📋 50 - 10% open · ⏱️ 24.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 820 / month):
	```
	pip install andes
	```
...
<details><summary><b><a href="https://github.com/OpenIPSL/OpenIPSL">OpenIPSL</a></b> (🥈15 ·  ⭐ 58 · 📉) - A library of power system models written with Modelica. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/modelica-3rdparty/PowerSystems">PowerSystems</a></b> (🥉14 ·  ⭐ 53) - Modelica 3rd party library for electrical power systems. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 110 · 🔀 410 · 📦 240 · 📋 850 - 20% open · ⏱️ 13.06.2023):
...
<details><summary><b><a href="https://pypsa.org">PyPSA</a></b> (🥇29 ·  ⭐ 870) - Simulating and optimising power and energy systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 60 · 🔀 350 · 📦 100 · 📋 260 - 24% open · ⏱️ 21.06.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 77 · 📥 30 · 📦 6 · 📋 78 - 1% open · ⏱️ 30.05.2023):
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈23 ·  ⭐ 76) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 14 · 🔀 13 · 📥 1.5K · 📦 3 · 📋 79 - 39% open · ⏱️ 22.06.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 30 · 🔀 45 · 📋 270 - 8% open · ⏱️ 14.06.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 130 · 📥 300K · 📋 150 - 13% open · ⏱️ 31.05.2023):
...
- [PyPi](https://pypi.org/project/matpower) (📥 480 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 760 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 49 · 🔀 140 · 📋 320 - 36% open · ⏱️ 20.06.2023):
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 95 · 📦 84 · 📋 37 - 70% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 92 · 📦 23 · 📋 32 - 46% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/BDonnot/lightsim2grid/
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 7 · 🔀 28 · 📥 570 · 📋 310 - 20% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/blue-marble/gridpath
	```
</details>
<details><summary><b><a href="https://pypsa.org">PyPSA-Eur-Sec</a></b> (🥉15 ·  ⭐ 79 · 📉) - Sector-Coupled Optimisation Model of the European Energy.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 94 - 15% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/mzy2240/ESA
	```
- [PyPi](https://pypi.org/project/esa) (📥 4K / month):
	```
	pip install esa
	```
</details>
...
<details><summary><b><a href="https://github.com/PauloRadatz/py_dss_interface">py-dss-interface</a></b> (🥉14 ·  ⭐ 17) - A package for access to direct dll version of OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📋 53 - 60% open · ⏱️ 04.06.2023):

	```
	git clone https://github.com/PauloRadatz/py_dss_interface
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 580 / month):
	```
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 64 · 🔀 200 · 📦 120 · 📋 420 - 7% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/scipopt/PySCIPOpt
	```
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 82K / month):
	```
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥈29 ·  ⭐ 560 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 20 · 📋 460 - 12% open · ⏱️ 15.06.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 7.5K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 27 · 🔀 230 · 📥 8K · 📋 540 - 1% open · ⏱️ 21.06.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 41 · 📋 44 - 27% open · ⏱️ 21.06.2023):

	```
	git clone https://github.com/ampl/amplpy
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 9.7K / month):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.4K · 📦 1.4K · 📋 1.2K - 24% open · ⏱️ 22.06.2023):
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 7.5K · 📋 180 - 22% open · ⏱️ 10.05.2023):
...
- [PyPi](https://pypi.org/project/cvxopt) (📥 220K / month):
	...
	pip install cvxopt
	```
- [Conda](https://anaconda.org/anaconda/cvxopt) (📥 9.1K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 140 · 🔀 370 · 📋 1.4K - 0% open · ⏱️ 19.06.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 27 · 🔀 89 · 📋 280 - 14% open · ⏱️ 06.06.2023):
...
- [PyPi](https://pypi.org/project/Grid2Op) (📥 2K / month):
	...
	pip install Grid2Op
	```
- [Docker Hub](https://hub.docker.com/r/bdonnot/grid2op) (📥 9K · ⭐ 1 · ⏱️ 05.07.2022):
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 350 · 📋 7K - 23% open · ⏱️ 22.06.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 51 · 🔀 150 · 📥 17K · 📋 700 - 24% open · ⏱️ 21.06.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 12K · ⏱️ 22.06.2023):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 17 · 🔀 41 · 📦 8 · 📋 110 - 35% open · ⏱️ 15.03.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 59 · 📦 22 · 📋 100 - 20% open · ⏱️ 20.06.2023):
...
<details><summary><b><a href="https://pypsa.org">powerplantmatching</a></b> (🥉21 ·  ⭐ 110) - Tools to combine multiple power plant databases. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 45 · 📥 48 · 📦 18 · 📋 67 - 22% open · ⏱️ 20.06.2023):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 360 / month):
	```
