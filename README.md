...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 420 · 📦 280 · 📋 870 - 17% open · ⏱️ 15.09.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 65 · 🔀 370 · 📦 120 · 📋 280 - 23% open · ⏱️ 21.09.2023):
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈24 ·  ⭐ 83 · 📈) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 16 · 📥 580 · 📦 3 · 📋 88 - 37% open · ⏱️ 18.09.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 48 · 📋 270 - 7% open · ⏱️ 21.09.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 75 · 📥 32 · 📦 7 · 📋 79 - 2% open · ⏱️ 21.08.2023):

	```
	git clone https://github.com/SanPen/GridCal
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 2.4K / month):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 54 · 🔀 150 · 📋 330 - 35% open · ⏱️ 21.09.2023):
...
- [PyPi](https://pypi.org/project/matpower) (📥 120 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 960 · ⏱️ 23.12.2022):
	```
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">LightSim2Grid</a></b> (🥉17 ·  ⭐ 39) - A fast backend for the Grid2Op. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 25 · 📋 33 - 48% open · ⏱️ 24.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 3.8K / month):
	```
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 7 · 🔀 30 · 📥 620 · 📋 310 - 20% open · ⏱️ 24.01.2023):
...
<details><summary><b><a href="https://dss-extensions.org/">OpenDSSDirect.py</a></b> (🥇19 ·  ⭐ 72 · 📈) - A direct library interface to OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 39 · 📋 95 - 15% open · ⏱️ 02.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 2.8K / month):
	```
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 98 - 15% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 3.5K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 27 - 62% open · ⏱️ 14.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydss) (📥 31 / month):
	```
	pip install pydss
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 64 · 🔀 210 · 📦 130 · 📋 440 - 6% open · ⏱️ 03.07.2023):
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥈27 ·  ⭐ 630) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 130 · 📦 30 · 📋 490 - 12% open · ⏱️ 05.09.2023):
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 28 · 🔀 240 · 📥 8.9K · 📋 550 - 1% open · ⏱️ 16.09.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 48 · ⏱️ 21.09.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.8K · 📦 1.5K · 📋 1.2K - 25% open · ⏱️ 19.09.2023):
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 8K · 📋 180 - 19% open · ⏱️ 09.08.2023):

	```
	git clone https://github.com/cvxopt/cvxopt
	```
- [PyPi](https://pypi.org/project/cvxopt) (📥 270K / month):
	```
	pip install cvxopt
	```
- [Conda](https://anaconda.org/anaconda/cvxopt) (📥 9.8K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 21.09.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 30 · 🔀 98 · 📋 300 - 11% open · ⏱️ 18.09.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 360 · 📋 7.2K - 23% open · ⏱️ 21.09.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 20K · 📋 750 - 24% open · ⏱️ 21.09.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 13K · ⏱️ 21.09.2023):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 18 · 🔀 41 · 📦 11 · 📋 120 - 37% open · ⏱️ 19.09.2023):

	```
	git clone https://github.com/e2nIEE/pandapipes
	```
- [PyPi](https://pypi.org/project/pandapipes) (📥 930 / month):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 65 · 📦 31 · 📋 110 - 22% open · ⏱️ 12.09.2023):
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 47 · 📥 51 · 📦 24 · 📋 72 - 25% open · ⏱️ 25.07.2023):
