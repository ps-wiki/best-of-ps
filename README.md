...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 79 · 📋 51 - 9% open · ⏱️ 11.08.2023):

	```
	git clone https://github.com/CURENT/andes
	```
- [PyPi](https://pypi.org/project/andes) (📥 310 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/changgang/steps) (👨‍💻 4 · 🔀 14 · 📥 12 · 📦 5 · 📋 2 - 50% open · ⏱️ 16.10.2023):
...
<details><summary><b><a href="https://www.pandapower.org/">pandapower</a></b> (🥇31 ·  ⭐ 690) - Convenient Power System Modelling and Analysis. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 420 · 📦 300 · 📋 880 - 18% open · ⏱️ 08.11.2023):
...
<details><summary><b><a href="https://pypsa.org">PyPSA</a></b> (🥇30 ·  ⭐ 960) - Simulating and optimising power and energy systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 66 · 🔀 380 · 📦 140 · 📋 290 - 23% open · ⏱️ 14.11.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 5.4K / month):
	```
	pip install pypsa
	```
...
<details><summary><b><a href="https://www.advancedgridinsights.com/gridcal">GridCal</a></b> (🥈23 ·  ⭐ 350) - Cross-platform power systems software. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 31 · 🔀 75 · 📥 32 · 📦 7 · 📋 130 - 38% open · ⏱️ 16.11.2023):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 19 · 📥 640 · 📦 4 · 📋 94 - 35% open · ⏱️ 14.11.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 48 · 📋 270 - 8% open · ⏱️ 16.11.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 55 · 🔀 160 · 📋 340 - 35% open · ⏱️ 16.11.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 400K · 📋 170 - 16% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 8 · 🔀 32 · 📥 660 · 📦 2 · 📋 310 - 19% open · ⏱️ 07.11.2023):

	```
	git clone https://github.com/blue-marble/gridpath
	```
</details>
<details><summary><b><a href="https://github.com/lanl-ansi/PowerModels.jl">PowerModels.jl</a></b> (🥉16 ·  ⭐ 350 · 📉) - Power Network Optimization. <code><a href="https://tldrlegal.com/search?q=BSD">❗️BSD</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 22 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 630 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 45 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 140 · 📦 46 · 📋 520 - 12% open · ⏱️ 14.11.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 28K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 66 · 🔀 210 · 📦 130 · 📋 460 - 5% open · ⏱️ 13.11.2023):

	```
	git clone https://github.com/scipopt/PySCIPOpt
	```
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 70K / month):
	```
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 29 · 🔀 250 · 📥 9.6K · 📋 560 - 0% open · ⏱️ 15.11.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 53 · 📋 44 - 2% open · ⏱️ 15.11.2023):

	```
	git clone https://github.com/ampl/amplpy
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 9.8K / month):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.9K · 📦 1.6K · 📋 1.3K - 24% open · ⏱️ 15.11.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 16.11.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 31 · 🔀 100 · 📋 310 - 13% open · ⏱️ 26.10.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.3K - 23% open · ⏱️ 16.11.2023):

	```
	git clone https://github.com/OpenModelica/OpenModelica
	```
- [Docker Hub](https://hub.docker.com/r/openmodelica/openmodelica) (📥 30K · ⭐ 5 · ⏱️ 15.11.2023):
	```
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 21K · 📋 770 - 22% open · ⏱️ 16.11.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 16.11.2023):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 100) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 18 · 🔀 45 · 📦 13 · 📋 120 - 38% open · ⏱️ 13.11.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 67 · 📦 43 · 📋 110 - 21% open · ⏱️ 08.11.2023):
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 46 · 📥 51 · 📦 34 · 📋 73 - 26% open · ⏱️ 31.10.2023):
