...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 78 · 📋 51 - 9% open · ⏱️ 11.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 420 / month):
	```
	pip install andes
	```
...
<details><summary><b><a href="https://github.com/OpenIPSL/OpenIPSL">OpenIPSL</a></b> (🥈16 ·  ⭐ 63) - A library of power system models written with Modelica. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/changgang/steps) (👨‍💻 4 · 🔀 14 · 📥 11 · 📦 5 · 📋 2 - 50% open · ⏱️ 16.10.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 420 · 📦 290 · 📋 880 - 18% open · ⏱️ 08.11.2023):

	```
	git clone https://github.com/e2nIEE/pandapower
	```
- [PyPi](https://pypi.org/project/pandapower) (📥 22K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 65 · 🔀 380 · 📦 140 · 📋 290 - 23% open · ⏱️ 07.11.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 5K / month):
	```
	pip install pypsa
	```
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈23 ·  ⭐ 95) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 17 · 📥 600 · 📦 4 · 📋 94 - 36% open · ⏱️ 08.11.2023):
...
<details><summary><b><a href="https://www.nrel.gov/analysis/siip.html">PowerSimulations.jl</a></b> (🥈22 ·  ⭐ 240) - Optimization of Power Systems; Part of the SIIP at.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 48 · 📋 270 - 8% open · ⏱️ 01.11.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 55 · 🔀 160 · 📋 340 - 35% open · ⏱️ 08.11.2023):
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 25 · 📋 38 - 31% open · ⏱️ 05.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 4.2K / month):
	```
...
<details><summary><b><a href="https://matpower.org/">matpower</a></b> (🥉19 ·  ⭐ 350) - Steady state power flow simulation. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 400K · 📋 170 - 14% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 8 · 🔀 31 · 📥 650 · 📦 2 · 📋 310 - 19% open · ⏱️ 07.11.2023):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 38 · 🔀 36 · 📥 20K · 📋 630 - 12% open · ⏱️ 11.07.2023):
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 41 · 📋 95 - 15% open · ⏱️ 02.07.2023):
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 29 - 58% open · ⏱️ 26.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydss) (📥 37 / month):
	```
	pip install pydss
	```
</details>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 22 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 570 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 40 / month):
	```
	pip install dssdata
	```
</details>
...
<details><summary><b><a href="https://www.scipopt.org/">PySCIPOpt</a></b> (🥇30 ·  ⭐ 690 · ➕) - Python interface for SCIP. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 66 · 🔀 210 · 📦 130 · 📋 460 - 5% open · ⏱️ 06.11.2023):
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇30 ·  ⭐ 670 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 130 · 📦 41 · 📋 520 - 11% open · ⏱️ 08.11.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 26K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 29 · 🔀 240 · 📥 9.5K · 📋 560 - 0% open · ⏱️ 09.11.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 440 · 📥 1.9K · 📦 1.6K · 📋 1.3K - 24% open · ⏱️ 08.11.2023):
...
<details><summary><b><a href="https://cvxopt.org/">CVXOPT</a></b> (🥉27 ·  ⭐ 920 · ➕) - Python Software for Convex Optimization. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 200 · 📦 8.4K · 📋 180 - 20% open · ⏱️ 09.08.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 08.11.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.3K - 23% open · ⏱️ 09.11.2023):

	```
	git clone https://github.com/OpenModelica/OpenModelica
	```
- [Docker Hub](https://hub.docker.com/r/openmodelica/openmodelica) (📥 30K · ⭐ 5 · ⏱️ 05.05.2023):
	```
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 21K · 📋 760 - 22% open · ⏱️ 08.11.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 09.11.2023):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 68 · 📦 40 · 📋 110 - 21% open · ⏱️ 08.11.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 2.2K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 46 · 📥 51 · 📦 32 · 📋 73 - 26% open · ⏱️ 31.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 470 / month):
	```
