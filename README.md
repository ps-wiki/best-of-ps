...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 75 · 📦 12 · 📋 50 - 10% open · ⏱️ 22.06.2023):

	```
	git clone https://github.com/CURENT/andes
	```
- [PyPi](https://pypi.org/project/andes) (📥 790 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulationsDynamics.jl) (👨‍💻 13 · 🔀 30 · 📋 120 - 31% open · ⏱️ 28.06.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 110 · 🔀 410 · 📦 250 · 📋 850 - 20% open · ⏱️ 13.06.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 61 · 🔀 350 · 📦 110 · 📋 260 - 25% open · ⏱️ 29.06.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 77 · 📥 30 · 📦 6 · 📋 78 - 1% open · ⏱️ 27.06.2023):
...
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈23 ·  ⭐ 77) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 14 · 🔀 13 · 📥 990 · 📦 3 · 📋 79 - 37% open · ⏱️ 29.06.2023):
...
<details><summary><b><a href="https://pypsa.org">PyPSA-Eur</a></b> (🥉20 ·  ⭐ 210) - Optimisation Model of the European Transmission System. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 49 · 🔀 140 · 📋 320 - 36% open · ⏱️ 29.06.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 130 · 📥 300K · 📋 150 - 13% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/matpower) (📥 510 / month):
	```
	pip install matpower
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 780 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 96 · 📦 84 · 📋 37 - 70% open · ⏱️ 29.03.2023):
...
<details><summary><b><a href="https://www.gridpath.io/">GridPath</a></b> (🥉17 ·  ⭐ 71) - Power system planning and operations. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://helics.org/tools/">HELICS</a></b> (🥇20 ·  ⭐ 95 · 📉) - Framework to Integrate Simulators. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 37 · 📋 93 - 15% open · ⏱️ 28.06.2023):

	```
	git clone https://github.com/dss-extensions/OpenDSSDirect.py
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 4.1K / month):
	```
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 95 - 15% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 3.9K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 20 · 📋 53 - 60% open · ⏱️ 04.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 420 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 26 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 62 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 64 · 🔀 200 · 📦 120 · 📋 420 - 7% open · ⏱️ 26.06.2023):
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 21 · 📋 460 - 13% open · ⏱️ 29.06.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 7.4K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 42 · 📋 44 - 27% open · ⏱️ 26.06.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.4K · 📦 1.4K · 📋 1.2K - 24% open · ⏱️ 28.06.2023):

	```
	git clone https://github.com/Pyomo/pyomo
	```
- [PyPi](https://pypi.org/project/Pyomo) (📥 160K / month):
	```
	pip install Pyomo
	```
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 27 · 🔀 89 · 📋 280 - 14% open · ⏱️ 06.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 1.9K / month):
	```
	pip install Grid2Op
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 350 · 📋 7K - 23% open · ⏱️ 29.06.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 51 · 🔀 150 · 📥 18K · 📋 710 - 24% open · ⏱️ 28.06.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 640 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 12K · ⏱️ 29.06.2023):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 83) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 60 · 📦 23 · 📋 100 - 20% open · ⏱️ 28.06.2023):
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 44 · 📥 48 · 📦 18 · 📋 68 - 22% open · ⏱️ 29.06.2023):
