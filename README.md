...
- [PyPi](https://pypi.org/project/andes) (📥 5.1K / month · 📦 4 · ⏱️ 12.03.2026):
	...
	pip install andes
	```
- [Conda](https://anaconda.org/conda-forge/andes) (📥 830K · ⏱️ 27.03.2026):
	```
...
- [Docker Hub](https://hub.docker.com/r/CURENT/andes):
	...
	```
- [Julia](https://juliahub.com/ui/Packages/General/Andes):
	```
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 22 · 🔀 130 · 📦 170 · 📋 57 - 73% open · ⏱️ 01.08.2026):
...
- [GitHub](https://github.com/NatLabRockies/dgen) (👨‍💻 14 · 🔀 180 · 📋 45 - 53% open · ⏱️ 17.02.2026):
...
- [GitHub](https://github.com/NatLabRockies/ASSET) (👨‍💻 3 · 🔀 7 · ⏱️ 14.09.2026):
	...
	```
- Paper (📚 1 citation): [10.1109/PESGM52009.2025.11225841](https://doi.org/10.1109/PESGM52009.2025.11225841)
</details>
...
- [GitHub](https://github.com/Sienna-Platform/PowerSystemsInvestments.jl) (👨‍💻 4 · 🔀 12 · 📋 33 - 57% open · ⏱️ 20.06.2026):
...
- [GitHub](https://github.com/pnnl/tesp) (👨‍💻 31 · 🔀 42 · 📥 540 · 📦 3 · 📋 130 - 27% open · ⏱️ 16.09.2026):
...
- [GitHub](https://github.com/osqp/osqp) (👨‍💻 36 · 🔀 410 · 📥 240K · 📋 400 - 30% open · ⏱️ 10.11.2025):
...
- [PyPi](https://pypi.org/project/xopt) (📥 1.7K / month · 📦 12 · ⏱️ 03.09.2026):
	...
	pip install xopt
	```
- [Conda](https://anaconda.org/conda-forge/xopt) (📥 100K · ⏱️ 04.09.2026):
	```
...
- [PyPi](https://pypi.org/project/kvxopt) (📥 11K / month · 📦 14 · ⏱️ 07.09.2026):
	...
	pip install kvxopt
	```
- [Conda](https://anaconda.org/conda-forge/kvxopt) (📥 520K · ⏱️ 07.09.2026):
	```
...
- <b><a href="https://github.com/embotech/ecos">ECOS</a></b> (🥈41 ·  ⭐ 550 · 🧊) - Conic solver for second-order cone programming. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/c.ico" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/e2nIEE/simbench) (👨‍💻 7 · 🔀 39 · 📦 53 · 📋 39 - 15% open · ⏱️ 22.09.2026):
...
<details><summary><b><a href="https://github.com/open-energy-transition/pypsa-mcp">PyPSA MCP</a></b> (🥈10 ·  ⭐ 72) - PyPSA Energy Modeling for LLMs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code></summary>
