...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 77 · 📦 12 · 📋 50 - 10% open · ⏱️ 22.06.2023):

	```
	git clone https://github.com/CURENT/andes
	```
- [PyPi](https://pypi.org/project/andes) (📥 1.4K / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulationsDynamics.jl) (👨‍💻 13 · 🔀 31 · 📋 120 - 32% open · ⏱️ 11.07.2023):
...
<details><summary><b><a href="https://github.com/modelica-3rdparty/PowerSystems">PowerSystems</a></b> (🥉14 ·  ⭐ 54) - Modelica 3rd party library for electrical power systems. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>
...
<details><summary><b><a href="https://www.pandapower.org/">pandapower</a></b> (🥇31 ·  ⭐ 640) - Convenient Power System Modelling and Analysis. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 110 · 🔀 410 · 📦 250 · 📋 850 - 19% open · ⏱️ 13.07.2023):
...
<details><summary><b><a href="https://pypsa.org">PyPSA</a></b> (🥇30 ·  ⭐ 880) - Simulating and optimising power and energy systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 62 · 🔀 360 · 📦 110 · 📋 260 - 22% open · ⏱️ 13.07.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 3.8K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 30 · 🔀 77 · 📥 31 · 📦 6 · 📋 79 - 2% open · ⏱️ 27.06.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 30 · 🔀 45 · 📋 270 - 8% open · ⏱️ 10.07.2023):

	```
	git clone https://github.com/nrel-siip/powersimulations.jl
	```
</details>
<details><summary><b><a href="https://github.com/PowerGridModel/power-grid-model">Power Grid Model</a></b> (🥈22 ·  ⭐ 78) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 14 · 🔀 14 · 📥 630 · 📦 3 · 📋 80 - 37% open · ⏱️ 29.06.2023):
...
<details><summary><b><a href="rwl.github.io/PYPOWER/api/">PYPOWER</a></b> (🥉20 ·  ⭐ 270) - Port of MATPOWER to Python. <code><a href="https://tldrlegal.com/search?q=BSD">❗️BSD</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 49 · 🔀 140 · 📋 320 - 36% open · ⏱️ 11.07.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 130 · 📥 310K · 📋 160 - 14% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 380 / month):
	```
	pip install matpower
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 810 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 98 · 📦 24 · 📋 32 - 46% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/BDonnot/lightsim2grid/
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 3.6K / month):
	```
...
- [GitHub](https://github.com/grid-parity-exchange/Egret) (👨‍💻 38 · 🔀 43 · 📦 5 · 📋 80 - 53% open · ⏱️ 23.05.2023):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 7 · 🔀 28 · 📥 590 · 📋 310 - 20% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 38 · 📋 93 - 15% open · ⏱️ 02.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 3.8K / month):
	```
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 96 - 15% open · ⏱️ 05.06.2023):
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 20 · 📋 53 - 60% open · ⏱️ 04.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 350 / month):
	```
	pip install py-dss-interface
	```
</details>
<details><summary><b><a href="https://www.nrel.gov/grid/pydss.html">PyDSS</a></b> (🥉14 ·  ⭐ 26) - A Python wrapper for OpenDSS. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/felipemarkson/dssdata">DSSData</a></b> (🥉10 ·  ⭐ 10) - A micro-framework for simulation and data analysis of distribution.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 51 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 64 · 🔀 200 · 📦 120 · 📋 430 - 6% open · ⏱️ 03.07.2023):
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 21 · 📋 470 - 13% open · ⏱️ 05.07.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 7.3K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 27 · 🔀 230 · 📥 8.2K · 📋 540 - 1% open · ⏱️ 21.06.2023):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 42 · 📋 44 - 22% open · ⏱️ 11.07.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.5K · 📦 1.4K · 📋 1.2K - 24% open · ⏱️ 06.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/Pyomo) (📥 210K / month):
	```
	pip install Pyomo
	```
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 7.6K · 📋 180 - 22% open · ⏱️ 10.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/cvxopt) (📥 190K / month):
	```
	pip install cvxopt
	```
- [Conda](https://anaconda.org/anaconda/cvxopt) (📥 9.2K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 140 · 🔀 370 · 📋 1.4K - 0% open · ⏱️ 07.07.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 27 · 🔀 89 · 📋 280 - 15% open · ⏱️ 06.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 2.3K / month):
	```
	pip install Grid2Op
	```
- [Docker Hub](https://hub.docker.com/r/bdonnot/grid2op) (📥 9.3K · ⭐ 1 · ⏱️ 05.07.2022):
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 350 · 📋 7.1K - 23% open · ⏱️ 13.07.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 51 · 🔀 150 · 📥 18K · 📋 720 - 24% open · ⏱️ 11.07.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 500 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 12K · ⏱️ 13.07.2023):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 88) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/CURENT/agvis) (👨‍💻 9 · 🔀 6 · 📥 9 · 📋 15 - 86% open · ⏱️ 02.06.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 61 · 📦 23 · 📋 100 - 21% open · ⏱️ 11.07.2023):
...
<details><summary><b><a href="https://pypsa.org">powerplantmatching</a></b> (🥉21 ·  ⭐ 120) - Tools to combine multiple power plant databases. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 45 · 📥 51 · 📦 18 · 📋 71 - 23% open · ⏱️ 13.07.2023):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 220 / month):
	```
