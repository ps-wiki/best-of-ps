...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 63 · 🔀 360 · 📦 120 · 📋 270 - 22% open · ⏱️ 17.08.2023):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 16 · 🔀 14 · 📥 480 · 📦 3 · 📋 83 - 33% open · ⏱️ 16.08.2023):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 52 · 🔀 140 · 📋 330 - 34% open · ⏱️ 14.08.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 340K · 📋 160 - 14% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 290 / month):
	```
	pip install matpower
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 880 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 8 · 📦 3 · 📋 98 - 15% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 2.6K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 43 / month):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 53 · 🔀 120 · 📦 26 · 📋 480 - 12% open · ⏱️ 05.07.2023):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/highspy) (📥 14K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 46 · 📋 44 - 22% open · ⏱️ 19.07.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 130 · 🔀 430 · 📥 1.6K · 📦 1.5K · 📋 1.2K - 25% open · ⏱️ 17.08.2023):
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 8 · 🔀 190 · 📦 7.8K · 📋 180 - 18% open · ⏱️ 09.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/cvxopt) (📥 250K / month):
	```
	pip install cvxopt
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 260 · 📥 360 · 📋 7.1K - 23% open · ⏱️ 17.08.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 19K · 📋 740 - 24% open · ⏱️ 17.08.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 600 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 13K · ⏱️ 17.08.2023):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 17 · 🔀 41 · 📦 10 · 📋 110 - 36% open · ⏱️ 16.08.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 27 · 🔀 61 · 📦 27 · 📋 110 - 23% open · ⏱️ 25.07.2023):
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 20 · 🔀 45 · 📥 51 · 📦 22 · 📋 72 - 25% open · ⏱️ 25.07.2023):
