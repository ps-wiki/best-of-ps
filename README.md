...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 80 · 📋 52 - 11% open · ⏱️ 11.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 360 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulationsDynamics.jl) (👨‍💻 13 · 🔀 31 · 📋 130 - 31% open · ⏱️ 05.01.2024):

	```
	git clone https://github.com/NREL-SIIP/PowerSimulationsDynamics.jl
	```
</details>
<details><summary><b><a href="https://github.com/OpenIPSL/OpenIPSL">OpenIPSL</a></b> (🥈16 ·  ⭐ 64 · 📉) - A library of power system models written with Modelica. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 130 · 🔀 430 · 📦 310 · 📋 900 - 18% open · ⏱️ 10.01.2024):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 68 · 🔀 390 · 📦 150 · 📋 300 - 24% open · ⏱️ 31.12.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 34 · 🔀 76 · 📥 33 · 📦 7 · 📋 130 - 39% open · ⏱️ 11.01.2024):

	```
	git clone https://github.com/SanPen/GridCal
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 540 / month):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 18 · 🔀 20 · 📥 580 · 📦 4 · 📋 110 - 40% open · ⏱️ 10.01.2024):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 59 · 🔀 170 · 📋 360 - 35% open · ⏱️ 11.01.2024):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 49 · 📋 280 - 9% open · ⏱️ 11.01.2024):
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 20 · 🔀 100 · 📦 94 · 📋 38 - 71% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 27 · 📋 42 - 38% open · ⏱️ 05.10.2023):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 9 · 🔀 33 · 📥 720 · 📦 2 · 📋 320 - 19% open · ⏱️ 14.12.2023):
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 11 · 🔀 9 · 📦 4 · 📋 99 - 16% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 1.8K / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 24 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 210 / month):
	```
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 30 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 24 / month):
	```
	pip install dssdata
	```
</details>
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇30 ·  ⭐ 720 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 140 · 📦 56 · 📋 550 - 12% open · ⏱️ 09.01.2024):
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 67 · 🔀 210 · 📦 140 · 📋 470 - 3% open · ⏱️ 11.01.2024):
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 29 · 🔀 250 · 📥 10K · 📋 560 - 1% open · ⏱️ 12.12.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 140 · 🔀 460 · 📥 2K · 📦 1.7K · 📋 1.3K - 20% open · ⏱️ 11.01.2024):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 11.01.2024):
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">Grid2Op</a></b> (🥇24 ·  ⭐ 250) - Modeling sequential decision making in power systems. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://raw.githubusercontent.com/ml-tooling/best-of-ml-python/main/config/images/jupyter.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.4K - 24% open · ⏱️ 11.01.2024):

	```
	git clone https://github.com/OpenModelica/OpenModelica
	```
- [Docker Hub](https://hub.docker.com/r/openmodelica/openmodelica) (📥 33K · ⭐ 5 · ⏱️ 15.12.2023):
	```
	docker pull openmodelica/openmodelica
	```
</details>
<details><summary><b><a href="https://precice.org/">precice</a></b> (🥉23 ·  ⭐ 630) - Precise Code Interaction Coupling Environment. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/precice/precice) (👨‍💻 55 · 🔀 160 · 📥 22K · 📋 790 - 22% open · ⏱️ 11.01.2024):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 75 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 11.01.2024):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 20 · 🔀 46 · 📦 14 · 📋 120 - 37% open · ⏱️ 22.12.2023):

	```
	git clone https://github.com/e2nIEE/pandapipes
	```
- [PyPi](https://pypi.org/project/pandapipes) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 68 · 📦 47 · 📋 110 - 22% open · ⏱️ 29.12.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 1.5K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 22 · 🔀 47 · 📥 52 · 📦 38 · 📋 74 - 27% open · ⏱️ 02.01.2024):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 590 / month):
	```
