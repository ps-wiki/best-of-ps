...
- [GitHub](https://github.com/CURENT/andes) (👨‍💻 20 · 🔀 80 · 📋 52 - 11% open · ⏱️ 11.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 580 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 430 · 📦 300 · 📋 890 - 18% open · ⏱️ 03.01.2024):

	```
	git clone https://github.com/e2nIEE/pandapower
	```
- [PyPi](https://pypi.org/project/pandapower) (📥 9.9K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 68 · 🔀 390 · 📦 150 · 📋 300 - 23% open · ⏱️ 31.12.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 32 · 🔀 75 · 📥 33 · 📦 7 · 📋 130 - 39% open · ⏱️ 28.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 620 / month):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 18 · 🔀 20 · 📥 590 · 📦 4 · 📋 100 - 39% open · ⏱️ 04.01.2024):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 58 · 🔀 170 · 📋 350 - 34% open · ⏱️ 04.01.2024):
...
- [GitHub](https://github.com/lanl-ansi/PowerModels.jl) (👨‍💻 29 · 🔀 130 · 📋 470 - 18% open · ⏱️ 02.01.2024):
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">LightSim2Grid</a></b> (🥉18 ·  ⭐ 41) - A fast backend for the Grid2Op. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 8 · 📦 24 · 📋 53 - 60% open · ⏱️ 19.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 240 / month):
	```
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇30 ·  ⭐ 710 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 67 · 🔀 210 · 📦 140 · 📋 460 - 3% open · ⏱️ 30.12.2023):

	```
	git clone https://github.com/scipopt/PySCIPOpt
	```
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 17K / month):
	```
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 8 · 🔀 17 · 📦 56 · ⏱️ 29.12.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 140 · 🔀 450 · 📥 2K · 📦 1.7K · 📋 1.3K - 21% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 02.01.2024):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.4K - 24% open · ⏱️ 04.01.2024):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 22K · 📋 790 - 22% open · ⏱️ 02.01.2024):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 77 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 04.01.2024):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 67 · 📦 47 · 📋 110 - 21% open · ⏱️ 29.12.2023):
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 22 · 🔀 47 · 📥 52 · 📦 38 · 📋 74 - 27% open · ⏱️ 02.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 560 / month):
	```
