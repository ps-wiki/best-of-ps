...
- [GitHub](https://github.com/OpenIPSL/OpenIPSL) (👨‍💻 32 · 🔀 45 · 📥 480 · 📋 110 - 11% open · ⏱️ 23.11.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 120 · 🔀 430 · 📦 300 · 📋 890 - 19% open · ⏱️ 05.12.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 68 · 🔀 390 · 📦 150 · 📋 300 - 24% open · ⏱️ 13.12.2023):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 7.1K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 18 · 🔀 20 · 📥 630 · 📦 4 · 📋 100 - 38% open · ⏱️ 13.12.2023):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 32 · 🔀 48 · 📋 280 - 8% open · ⏱️ 14.12.2023):
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 13 · 🔀 140 · 📥 420K · 📋 170 - 16% open · ⏱️ 09.12.2023):

	```
	git clone https://github.com/MATPOWER/matpower
	```
- [PyPi](https://pypi.org/project/matpower) (📥 200 / month):
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 57 · 🔀 170 · 📋 350 - 36% open · ⏱️ 14.12.2023):
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 100 · 📦 27 · 📋 41 - 36% open · ⏱️ 05.10.2023):
...
<details><summary><b><a href="https://www.gridpath.io/">GridPath</a></b> (🥉18 ·  ⭐ 78) - Power system planning and operations. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 9 · 🔀 33 · 📥 690 · 📦 2 · 📋 320 - 19% open · ⏱️ 14.12.2023):
...
- [GitHub](https://github.com/lanl-ansi/PowerModels.jl) (👨‍💻 28 · 🔀 130 · 📋 470 - 19% open · ⏱️ 11.12.2023):
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 20 · 📦 43 · 📋 97 - 16% open · ⏱️ 02.07.2023):
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 24 · 🔀 16 · 📦 2 · 📋 29 - 58% open · ⏱️ 22.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydss) (📥 41 / month):
	```
	pip install pydss
	```
</details>
...
<details><summary><b><a href="https://highs.dev/">HiGHS</a></b> (🥇31 ·  ⭐ 690 · 📈) - Large-scale Sparse Linear Problem Optimizer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 60 · 🔀 140 · 📦 53 · 📋 540 - 11% open · ⏱️ 28.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/highspy) (📥 34K / month):
	```
	pip install highspy
	```
</details>
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 67 · 🔀 210 · 📦 140 · 📋 460 - 4% open · ⏱️ 11.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/PySCIPOpt) (📥 51K / month):
	```
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 29 · 🔀 250 · 📥 10K · 📋 560 - 0% open · ⏱️ 12.12.2023):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 140 · 🔀 450 · 📥 2K · 📦 1.6K · 📋 1.3K - 24% open · ⏱️ 13.12.2023):

	```
	git clone https://github.com/Pyomo/pyomo
	```
- [PyPi](https://pypi.org/project/Pyomo) (📥 340K / month):
	```
	pip install Pyomo
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 150 · 🔀 380 · 📋 1.4K - 0% open · ⏱️ 13.12.2023):
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 190 · 🔀 270 · 📥 360 · 📋 7.4K - 23% open · ⏱️ 13.12.2023):

	```
	git clone https://github.com/OpenModelica/OpenModelica
	```
- [Docker Hub](https://hub.docker.com/r/openmodelica/openmodelica) (📥 32K · ⭐ 5 · ⏱️ 15.11.2023):
	```
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 54 · 🔀 160 · 📥 22K · 📋 790 - 22% open · ⏱️ 11.12.2023):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 240 / month):
	```
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 14K · ⏱️ 14.12.2023):
	```
...
- [GitHub](https://github.com/lanl-ansi/GasModels.jl) (👨‍💻 11 · 🔀 14 · 📋 140 - 32% open · ⏱️ 06.12.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 28 · 🔀 66 · 📦 46 · 📋 110 - 21% open · ⏱️ 12.12.2023):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 2.8K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 22 · 🔀 47 · 📥 52 · 📦 37 · 📋 74 - 27% open · ⏱️ 31.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 490 / month):
	```
